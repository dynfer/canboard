...
LDSCRIPT= $(CHIBIOS)/os/common/startup/ARMCMx/compilers/GCC/ld/STM32F103x8.ld
...
# Define the C++ compiler and linker options
CXXFLAGS = $(USE_OPT) $(USE_CPPOPT) $(INCDIR:%=-I%) $(CPPWARN)
